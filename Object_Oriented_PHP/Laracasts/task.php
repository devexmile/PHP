...
class Task {
  ...
  // This method is also what is called a constructor.  A constructor is called right when a class is instantiated. 
  // - If arguments are made available/given when the class is instantiated, they will be passed to the constructor when fired. 
...
// Now in order to get access to the class we have to create an instance of the class. The instance of the class is called an object.
...
// Now you can have multiple instance of a class you just have to ensure you name them differently.
// $task2 = new Task('Work this MAN!');

// Now I'm going to have an instance of a class that will return two arguments ($title, $description). 
...
// Now in order to call the second instance of this class you have to update you information.
// var_dump($task2->description);

// So here I'm running a var_dump on the property above.  You must have an instance of the class in order for this to work.
